...
<body class="body-offset">
    ...
    <div class="container-fluid">
        <div class="container">
            ...
            <form class="faq-add-form" action="${pageContext.request.contextPath}/insert.fo" method="post" style="display: none;">
                ...
                <textarea id="faqContent" name="faqContent" placeholder="내용을 입력하세요" rows="4" required style="width: 100%;"></textarea>
 ...
 // 수정 버튼 클릭 시 수정 모드 활성화
    function editFaq(button) {
        ...
        const summary = contentDiv.closest('details').querySelector('summary'); // summary 태그
