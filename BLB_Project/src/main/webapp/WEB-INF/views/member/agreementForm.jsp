...
<div class="container-fluid" id="custom-page"  style="width:1200px;">    
    ...
    용합니다.
    제2조 (정의)
    ① “몰”이란 OO 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여
    ...
    매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 OO 사이버몰의 초기
    ...
    되고 그 이전에 이미 체결된 계약에 대해서는 개정 전의 약관조항이 그대로 적용됩니다. 다
    - 2 -
    만 이미 계약을 체결한 이용자가 개정약관 조항의 적용을 받기를 원하는 뜻을 제3항에 의한
    ...
    얻은 경우에는 예외로 합니다.
    2. 등록 내용에 허위, 기재누락, 오기가 있는 경우 3. 기타 회원으로 등록하는 것이 “몰”의 기술상 
    현저히 지장이 있다고 판단되는 경우
    ...
    을 명시합니다. 만약 “몰”이 약정 배송기간을 초과한 경우에는 그로 인한 이용자의 손해를 배
...
<br>           
    <div class="submit-row">
        <button class="btn-lg btn-outline-primary back" onclick="goBack()">취소</button>
        <button class="btn-lg btn-primary next" type="submit">다음</button>
    </div>
</div> 
</form>  
