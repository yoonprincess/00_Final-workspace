...
String goodsName 		= "나이스페이"; 					// 결제상품명 테이블
String price 			= "1004"; 						// 결제상품금액	테이블
String buyerName 		= "나이스"; 						// 구매자명 SESSION
String buyerTel 		= "01000000000"; 				// 구매자연락처 SESSTION
String buyerEmail 		= "happy@day.co.kr"; 			// 구매자메일주소 SESSTION
