...
<body>
    <div class="qna-container">
        <!-- 문의 수정 폼 -->
        <form id="qnaEditForm" action="update.pqa" method="post" enctype="multipart/form-data">
            <input type="hidden" id="inquiryNo" name="inquiryNo" value="${i.inquiryNo}">

            <!-- 문의 작성 -->
            <div class="form-group">
                <label for="inquiryContent">문의 수정란</label>
                <textarea 
                    class="form-control" 
                    id="inquiryContent" 
                    name="inquiryContent" 
                    rows="5" 
                    required
                    style="resize: none;">${i.inquiryContent}</textarea>
                <small id="charCount" class="form-text text-muted">${fn:length(i.inquiryContent)} / 1000자</small>
            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#qnaEditForm').on('submit', function (e) {
