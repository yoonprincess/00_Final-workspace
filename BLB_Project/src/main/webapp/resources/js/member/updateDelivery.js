	...
	$(document).ready(function(){
		 if (deliPhone.length === 11) {
	        $('#phone1').val(deliPhone.slice(0, 3));  
	        $('#phone2').val(deliPhone.slice(3, 7)); 
	        $('#phone3').val(deliPhone.slice(7));     
	        
	    } else if (deliPhone.length === 10) {
	    
	        $('#phone1').val(deliPhone.slice(0, 2));  
	        $('#phone2').val(deliPhone.slice(2, 6));  
	        $('#phone3').val(deliPhone.slice(6));    
	    }
	});
